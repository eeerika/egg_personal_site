...
**Citation:** Adult fish passage recorded from 2001-01-01 to 2010-12-31 at the Willamette Falls fish ladder on the Willamette River (Oregon). Data were shared by and accessed from Columbia River DART (Data Access in Real Time). http://www.cbr.washington.edu/dart/query/adult_graph_text
...
**Figure 2.** Seasonplots of adult passage counts constructed for steelhead, coho, and jack coho salmon species. Each year in the study period is presented as a different color on the graphs for each species.

### Trends:
- Steelhead salmon fluctuate a lot in adult passage count in most years near May-July, and somewhat in the beginning of the years.
- Coho and jack coho salmon fluctuate most near October in all years.
...
### Trends:
- Steelhead salmon saw an overall decrease over the time period.
- Coho salmon saw an overall increase over the time period, surpassing steelhead counts once in 2009.
